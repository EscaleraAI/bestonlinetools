...
export default function OcrTool() {
  ...
  const handleRecognize = useCallback(async () => {
    ...
    try {
      ...
      setStatus('error');
      setStatusText(err instanceof Error ? err.message : 'OCR failed');
    }
  }, [file, language]);
    ...
    return (
      <div className={styles.container}>
        <div className={styles.dropzone}
          ...
          <p className={styles.dropzoneTitle}>Drop an image to extract text</p>
          <p className={styles.dropzoneSubtitle}>Supports JPG, PNG, WebP, BMP, TIFF</p>
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.previewCol}>
          ...
          <div className={styles.actionRow}>
            <button className={styles.resetButton} onClick={handleReset}>Change</button>
          ...
          {status === 'done' ? (
            <>
              <div className={styles.resultHeader}>
                <span className={styles.confidenceBadge}>Confidence: {confidence}%</span>
                <div className={styles.resultActions}>
                  <button className={styles.copyBtn} onClick={handleCopy}>
                    {copied ? '✓ Copied!' : 'Copy'}
                  </button>
                  <button className={styles.copyBtn} onClick={handleDownloadTxt}>
                    .txt
                  </button>
                </div>
              </div>
